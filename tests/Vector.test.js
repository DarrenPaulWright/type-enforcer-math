...
describe('Vector', () => {
	describe('init', () => {
		it('should instantiate without any arguments', () => {
			...
			assert.equal(vector.start(), new Point(0, 0));
		});

		it('should accept a start', () => {
			const vector = new Vector([1, 2]);

			assert.equal(vector.start(), new Point(1, 2));
		});

		it('should accept an end', () => {
			const vector = new Vector([1, 2], [5, 4]);

			assert.equal(vector.end(), new Point(5, 4));
		});
		...
		it('should accept an array', () => {
			...
			assert.equal(vector.end(), new Point(3, 4));
		});
	...
	describe('.start', () => {
		it('should accept an Array when start is set', () => {
			...
			assert.equal(vector.start(), new Point(5, 6));
		});
		...
		it('should set the length when start is set', () => {
			...
			assert.equal(vector.length(), Math.sqrt(2));
		...
		it('should set the angle when start is set', () => {
			...
			assert.equal(vector.angle(), Math.PI * 5 / 4);
		});

		it('should set the offset when start is set', () => {
			const vector = new Vector([1, 1], [3, 5]);

			assert.equal(vector.offset(), new Point(2, 4));

			vector.start(new Point(3, -1));

			assert.equal(vector.offset(), new Point(0, 6));
		});
	});
	...
	describe('.end', () => {
		it('should accept an Array when end is set', () => {
			...
			assert.equal(vector.end(), new Point(5, 6));
		});
		...
		it('should accept an Object when end is set', () => {
			...
			assert.equal(vector.end(), new Point(1, 2));
		});
		...
		it('should set the angle when end is set', () => {
			...
			assert.equal(vector.angle(), Math.PI * 7 / 4);
		});
		...
		it('should set the offset when end is set', () => {
			...
			assert.equal(vector.offset(), new Point(2, -2));
		});
	});
	...
	describe('.invert', () => {
		it('should switch the start and end when invert is called', () => {
			...
			assert.equal(vector.start(), new Point(3, 5));
			assert.equal(vector.end(), new Point(1, 1));
		});
	...
	describe('.length', () => {
		...
		it('should set the end when length is set', () => {
			...
			assert.equal(vector.end(), new Point(3, 1));
		});

		it('should set the offset when angle is set', () => {
			const vector = new Vector([1, 1], [5, 1]);

			assert.equal(vector.offset(), new Point(4, 0));

			vector.length(2);

			assert.equal(vector.offset(), new Point(2, 0));
		});
	});
	...
	describe('.angle', () => {
		it('should set the angle when instantiated', () => {
			...
			assert.is(vector.angle(), Math.PI / 4);
		});
		...
		it('should set the end when angle is set', () => {
			...
			assert.equal(vector.end(), new Point(1.0000000000000002, 5));
		});
		...
		it('should set the offset when angle is set', () => {
			...
			assert.equal(vector.offset(), new Point(2.220446049250313e-16, 4));
		});
		...
		it('should normalize the angle when greater than 2 * PI', () => {
			...
			assert.is(vector.angle(), Math.PI / 2);
		});
		...
		it('should normalize the angle when less than 0', () => {
			...
			assert.is(vector.angle(), Math.PI * 3 / 2);
		});
	});
	...
	describe('.offset', () => {
		...
		it('should accept an Array when offset is set', () => {
			...
			assert.equal(vector.offset(), new Point(5, 6));
		});
		...
		it('should accept an Object when offset is set', () => {
			...
			assert.equal(vector.offset(), new Point(1, 2));
		});

		it('should set the end when offset is set', () => {
			const vector = new Vector([1, 1], [3, 5]);

			assert.equal(vector.end(), new Point(3, 5));

			vector.offset(new Point(5, 6));

			assert.equal(vector.end(), new Point(6, 7));
		});

		it('should set the length when offset is set', () => {
			const vector = new Vector([1, 1], [3, 5]);

			assert.equal(vector.length(), Math.sqrt(20));

			vector.offset(new Point(5, 6));

			assert.equal(vector.length(), Math.sqrt(61));
		});
	...
	describe('.toString', () => {
		it('should return a string of the vector', () => {
			assert.is(new Vector().toString(), '[[0,0],[0,0]]');
		});

		it('should return a string of the vector if custom', () => {
			assert.is(new Vector([1, 2], [3, 4]).toString(), '[[1,2],[3,4]]');
		});
	});

	describe('.valueOf', () => {
		it('should return a string of the vector', () => {
			assert.equal(new Vector().valueOf(), [[0, 0], [0, 0]]);
		});
